(function(exports){
    ...
    Player.prototype.getAllRatingNumbers = function (){
        var ratingNumbers = new Array(3);
        ratingNumbers[0] = this.__rating * scalingFactor + this.defaultRating;
        ratingNumbers[1] = this.__rd * scalingFactor;
        ratingNumbers[2] = this.__vol;
